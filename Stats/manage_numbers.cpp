...
public:
  Add_Number(std::vector<double> *_numbers) { this->_numbers = _numbers; }

  virtual std::string label() { return "Add Number"; }
...
public:
  Print_Numbers(std::vector<double> *_numbers) { this->_numbers = _numbers; }

  virtual std::string label() { return "Print Numbers"; }
...
public:
  Remove_Number(std::vector<double> *_numbers) { this->_numbers = _numbers; }

  virtual std::string label() { return "Remove a Number"; }
...
std::string Manage_Numbers::label() { return "Manage Numbers"; }
